	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					@if(Auth::user()->role === 2 )
					<li class="submenu">
						<a href="{{ route('tps.form') }}"><i class="fa fa-fw fa-file-text-o"></i>TPS</a>
					</li>
					@endif

					@if(Auth::user()->role === 0)
					<li class="submenu">
						<a class="submenu" href="{{ route('home') }}"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li>
					@endif

					@if(Auth::user()->role === 0 || Auth::user()->role === 1)
                    <li class="submenu">
						<a href="{{ route('tps.index') }}"><i class="fa fa-fw fa-file-text-o"></i>TPS</a>
                    </li>
					@endif

					@if(Auth::user()->role === 0)
                    <li class="submenu">
						<a href="{{ route('dapils.index') }}"><i class="fa fa-fw fa-table"></i>Dapil</a>
                    </li>
